      ...
      <div className="w-full h-full md:px-10 px-5">
        ...
        <div className="grid-12-cols mt-16">
          <div className="xl:col-span-5">
            <div className="flex flex-start flex-col card-border rounded-xl p-10 mb-6">
              <form
                ref={formRef}
              ...
              >
                <div>
                  <label htmlFor="name">Votre Nom ou Entreprise</label>
                  <input
                    type="text"
                    id="name"
                    name="name"
          ...
          <div className="xl:col-span-7 min-h-96 hidden mb-6 md:block">
